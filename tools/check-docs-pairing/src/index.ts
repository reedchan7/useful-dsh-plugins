...
// Build output and the plugin skeleton are not documentation: `plugins/*`
// READMEs are checked, `plugins/*/lib` is not.
const SKIP_DIRECTORIES = ['node_modules/', 'templates/', 'lib/', 'tools/']
